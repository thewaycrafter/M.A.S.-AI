...
export const freeTour: Step[] = [
    {
        target: 'body',
        content: 'Welcome to M.A.S. AI! Let me show you how to get started with security testing.',
        placement: 'center',
    },
    {
...
export const proTour: Step[] = [
    {
        target: 'body',
        content: 'Welcome to M.A.S. AI Pro! You now have unlimited access to all features.',
        placement: 'center',
    },
    {
        target: '[data-tour="start-scan"]',
...
export const adminTour: Step[] = [
    {
        target: 'body',
        content: 'Welcome, Admin! You have complete control over the M.A.S. AI platform.',
        placement: 'center',
    },
    {
